...
const SpinTheBottle = forwardRef(({ segments, onSpinEnd, totalStakes, spinDuration = 10000 }, ref) => {
    ...
    const draw = useCallback(() => {
        ...
        const scale = (innerRadius / bottleHeight) * 2.4;
        const scaledBottleWidth = bottleWidth * scale;
        const scaledBottleHeight = bottleHeight * scale;
        ctx.drawImage(bottleRef.current, centerX - scaledBottleWidth / 2, centerY - scaledBottleHeight / 2, scaledBottleWidth, scaledBottleHeight);
    ...
    return (
        <div style={{ background: 'url(/wood.png)', backgroundPosition:'center', display:'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '41px'}}>
