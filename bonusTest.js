...
const Game = () => {
 ...
 function showMorePlayer(){
  ...
  function getCurrentRoundAnimationClass(){
    let data =getCurrentAnimationClass(1890)
    return data
  }
  ...
  useEffect(() => {
    ...
    // console.log('mini,mega,superRound', mini,mega,superRound,roundData?.round)
...
let MiniBonusA = +BonusAmount({ name: 'mini', round: roundData?.round, bonus: roundData?.bonusPrize, isbonus: roundData?.isBonus, adjust: miniAdjust }) || 0.0000;
let MegaBonusA = +BonusAmount({ name: 'mega', round: roundData?.round, bonus: roundData?.bonusPrize, isbonus: roundData?.isBonus, adjust: megaAdjust }) || 0.0000;
let SuperBonusA = +BonusAmount({ name: 'super', round: roundData?.round, bonus: roundData?.bonusPrize, isbonus: roundData?.isBonus, adjust: superAdjust })|| 0.0000;
              ...
              <div className='bonus-block-icon'>
                ...
                <h2>
                  {/* <BonusAmount
                    ...
                    bonus={roundData?.bonusPrize}
                    isbonus={roundData?.isBonus}
                    adjust={miniAdjust}
                  /> */}
                  {/* {roundData?.round % 1000 == '0' && roundData?.round % 100 == '0' && roundData?.round % 10 == '0'
                    ? '0.0000'
                    : roundData?.round % 100 == '0' && roundData?.round % 10 == '0'
                    ? '0.0000'
                    : MiniBonusA} */}
                    {getCurrentAnimationClass(1890) === 'third' || getCurrentAnimationClass(1890) ==='second' ?"0.00000":getCurrentAnimationClass(1890) === 'first'? (+fromWei(1364445661333251)).toFixed(5):  miniAdjust===10?'0.00000':(MiniBonusA).toFixed(5)}
                </h2>
              </div>
              <p className={`${getCurrentRoundAnimationClass() === 'first' ? 'remove-text-active-bonus' : ''}`}>
                Next Game : Round <BonusRound round={1890} repeat={10} name='mini' adjust={miniAdjust} />
              </p>
            </div>
            <div
              className={`bonus-block-inner common-block-readius bonus-block-inner-${
              ...
              <div className='bonus-block-icon'>
                ...
                <h2>
                  {/* <BonusAmount
                    ...
                    adjust={megaAdjust}
                  /> */}
                  {/* {roundData?.round % 1000 == '0' && roundData?.round % 100 == '0' ? '0.0000' : MegaBonusA} */}
                  {/* {(+fromWei(3802322950749146.00000)).toFixed(5)} */}
                  {getCurrentAnimationClass(1890) === 'third' ?"0.00000":getCurrentAnimationClass(1890) === 'second'? (+fromWei(1364445661333251)).toFixed(5): megaAdjust===100?'0.00000':miniAdjust===10 ? (+MegaBonusA +  +MiniBonusA).toFixed(5) :(MegaBonusA).toFixed(5)}
                </h2>
              </div>
              <p className={`${getCurrentRoundAnimationClass() === 'second' ? 'remove-text-active-bonus' : ''}`}>
                Next Game : Round <BonusRound round={1890} repeat={100} name='mega' adjust={megaAdjust} />
              </p>
            </div>
            <div
              className={`bonus-block-inner common-block-readius bonus-block-inner-${
              ...
              <div className='bonus-block-icon'>
                ...
                <h2>
                  ...
                  /> */}
                  {/* {SuperBonusA} */}
                  {getCurrentAnimationClass(1890) === 'third'? (+fromWei(1364445661333251)).toFixed(5):megaAdjust===100? miniAdjust===10? (+SuperBonusA + +MegaBonusA + +MiniBonusA).toFixed(5):(+SuperBonusA + +MegaBonusA).toFixed(5) :(SuperBonusA).toFixed(5)}

                </h2>
              </div>
              <p className={`${getCurrentRoundAnimationClass() === 'third' ? 'remove-text-active-bonus' : ''}`}>
                Next Game : Round{' '}
                <BonusRound round={1890} repeat={1000} name='Super' adjust={superAdjust} />
              </p>
            </div>
